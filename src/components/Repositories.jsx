...
//   return (
//     <div className='h-screen w-full  flex flex-col gap-2 items-center'>
//       <div className='flex flex-col my-8 mx-5'>
//       <h1 className='font-bold text-3xl text-center text-white'>Repositories</h1>
//       </div>
//       <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  m-5 mt-2'>
//       {
//         obj.map((item,idx)=>{
//           return(
//             <div key={idx} className='hover:border-blue-500 hover:transition-2s border-2 gap-2 p-2 px-4 justify-evenly m-2 my-3 h-65 w-50 md:h-75 md:w-60 lg:h-80 rounded-3xl flex flex-col'>
...
//             <button className='hover:border-blue-500 hover:transition-2s cursor-pointer border rounded-2xl p-1 m-2' onClick={() => window.open(item.link, "_blank")}>View Repo</button>
//             </div>
//           )
//         })
//       }
